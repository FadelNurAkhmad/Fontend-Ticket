        ...
        <div className="swiper-tabs w-full overflow-hidden">
          ...
          >
            <SwiperSlide className="swiper-slide !w-fit py-[1px]">
              ...
              >
                <div className="flex rounded-full p-[12px_14px] bg-[#FFFFFF1A] font-semibold text-sm hover:ring-1 hover:ring-white transition-all duration-300 !bg-white !text-black">
                  About
                </div>
              </button>
            </SwiperSlide>

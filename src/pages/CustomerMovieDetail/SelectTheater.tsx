        ...
        <div id="Theaters" className="tab-content flex flex-col gap-4">
          ...
          {detail.theaters.map((item) => (
            <button
              ...
              className="relative theather-card flex items-center rounded-3xl p-4 gap-2 bg-white/10 backdrop-blur-md hover:bg-purple-700 has-[:checked]:bg-purple-700 transition-all duration-300"
            >
              <input
                type="radio"
                name="theater"
